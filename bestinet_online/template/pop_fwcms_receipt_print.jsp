...
--%><jsp:useBean id="FWCMSOnline" scope="page" class="com.rexit.easc.FWCMSOnline" /><%--
     ...
     The receipt is a single-page portrait document: gen_fwcms_pdf.jsp
...
<table width="900" border="1" cellspacing="0" cellpadding="3" bordercolor="#000000">
  <tr>
    <td align="left" valign="top" width="900" bgcolor="#E0E0E0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2.5"><b><%= common.stringToHTMLString(PRINCIPLE_NAME) %></b></font></td>
  </tr>
</table>

<%-- ============ TITLE ============ --%>
<table width="900" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
...
<%-- ============ SUBMISSION HEADER ============ --%>
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="200" bordercolor="#000000" valign="middle" bgcolor="#E0E0E0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Date</font></td>
    <td width="700" bordercolor="#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%= common.stringToHTMLString(ISSDATE) %></b></font></td>
  </tr>
</table>
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="200" bordercolor="#000000" valign="middle" bgcolor="#E0E0E0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Account No.</font></td>
    <td width="700" bordercolor="#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%= common.stringToHTMLString(ACCODE) %></b></font></td>
  </tr>
</table>
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="200" bordercolor="#000000" valign="middle" bgcolor="#E0E0E0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Employer Name</font></td>
    <td width="700" bordercolor="#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%= common.stringToHTMLString(EMPLOYER_NAME) %></b></font></td>
  </tr>
</table>
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="200" bordercolor="#000000" valign="middle" bgcolor="#E0E0E0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Business Reg. No.</font></td>
    <td width="700" bordercolor="#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%= common.stringToHTMLString(BUSINESS_NO) %></b></font></td>
  </tr>
</table>
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="200" bordercolor="#000000" valign="middle" bgcolor="#E0E0E0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">FWCMS Reference No.</font></td>
    <td width="700" bordercolor="#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%= common.stringToHTMLString(FWCMSREFNO) %></b></font></td>
  </tr>
</table>
...
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="40"  bgcolor="#E0E0E0" align="center"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">No.</font></b></center></td>
    <td width="230" bgcolor="#E0E0E0"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Product</font></b></center></td>
    <td width="150" bgcolor="#E0E0E0"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Cover Note / Policy No.</font></b></center></td>
    <td width="60"  bgcolor="#E0E0E0" align="center"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Workers</font></b></center></td>
    <td width="90"  bgcolor="#E0E0E0" align="right"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Gross</font></b></center></td>
    <td width="80"  bgcolor="#E0E0E0" align="right"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Rebate</font></b></center></td>
    <td width="70"  bgcolor="#E0E0E0" align="right"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">S/Tax</font></b></center></td>
    <td width="70"  bgcolor="#E0E0E0" align="right"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">S/Duty</font></b></center></td>
    <td width="110" bgcolor="#E0E0E0" align="right"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Nett Premium</font></b></center></td>
  </tr>
<%
	int rowNo = 1;
	for (int i = 0; i < alDTL.size(); i++)
...
%>
  <tr>
    <td width="40"  align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= rowNo %></font></td>
    <td width="230"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= sPRODUCT %></font></td>
    <td width="150"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.stringToHTMLString(sDISPCN) %></font></td>
    <td width="60"  align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.stringToHTMLString(sNO_WORKER) %></font></td>
    <td width="90"  align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(common.formatfloat(sGROSS)) %></font></td>
    <td width="80"  align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(common.formatfloat(sREBATE)) %></font></td>
    <td width="70"  align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(common.formatfloat(sSTAX)) %></font></td>
    <td width="70"  align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(common.formatfloat(sSTAMP)) %></font></td>
    <td width="110" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(common.formatfloat(sNETT)) %></font></td>
  </tr>
<%
		rowNo++;
	}
%>
  <tr bgcolor="#E0E0E0">
    <td width="40">&nbsp;</td>
    <td width="230"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Grand Total</font></b></td>
    <td width="150">&nbsp;</td>
    <td width="60"  align="center"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= iWORKERS %></font></b></td>
    <td width="90"  align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(fGROSS) %></font></b></td>
    <td width="80"  align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(fREBATE) %></font></b></td>
    <td width="70"  align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(fSTAX) %></font></b></td>
    <td width="70"  align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(fSTAMP) %></font></b></td>
    <td width="110" align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(fNETT) %></font></b></td>
  </tr>
</table>
...
<table width="900" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="40"  bgcolor="#E0E0E0" align="center"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">No.</font></b></center></td>
    <td width="220" bgcolor="#E0E0E0"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Payment Mode</font></b></center></td>
    <td width="420" bgcolor="#E0E0E0"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Payment Reference</font></b></center></td>
    <td width="220" bgcolor="#E0E0E0" align="right"><center><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Amount (RM)</font></b></center></td>
  </tr>
  <tr>
    <td width="40"  align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">1</font></td>
    <td width="220"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.stringToHTMLString(PAYMENT_METHOD_DESC) %></font></td>
    <td width="420"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.stringToHTMLString(PAYMENT_REF) %></font></td>
    <td width="220" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%= common.twoDecimal(common.formatfloat(common.fnCutComma(TOTAL_AMOUNT))) %></font></td>
  </tr>
  <tr>
    ...
    <td width="220" bordercolor="#000000" align="right"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%= common.twoDecimal(common.formatfloat(common.fnCutComma(TOTAL_AMOUNT))) %></font></b></td>
  </tr>
</table>
